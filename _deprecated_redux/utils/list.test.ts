...
test('rangeSize', () => {
  expect(rangeSize([0, 1])).toBe(1)
  expect(rangeSize([0, 0])).toBe(0)
  expect(rangeSize([5, 10])).toBe(5)
})

test('containsRange', () => {
  expect(containsRange([0, 100], [0, 100])).toBe(true)
  expect(containsRange([0, 100], [40, 50])).toBe(true)

  expect(containsRange([40, 50], [0, 100])).toBe(false)
  expect(containsRange([0, 100], [0, 101])).toBe(false)
  expect(containsRange([50, 100], [49, 100])).toBe(false)
})
