...
test('should get promise', (t) => {
  ...
  t.deepEqual(AsyncValue.prototype.handleRequest.args, [[STATE, PROMISE]])
})
...
test('should get error', (t) => {
  ...
  t.deepEqual(AsyncValue.prototype.handleFailure.args, [[STATE, ERROR]])
})
...
test('should get value', (t) => {
  ...
  t.deepEqual(AsyncValue.prototype.handleSuccess.args, [[STATE, VALUE]])
})
